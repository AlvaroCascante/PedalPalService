# GET `/v1/api/appointments/bike/{bikeId}/past` — Past appointments

Returns past appointments for a bike.
  ...
  "data": [
    {
      ...
      "scheduledAt": "2026-02-20T16:00:00Z",
      "status": "COMPLETED"
    }
  ],
  "message": "Success",
...
```http
GET /v1/api/appointments/bike/9c84b698-b3fc-4c9d-91f1-9bab8a53a466/past
