...
public class BikeController {
    ...
    public ResponseEntity<ApiResponse> create(
        ...
        CreateBikeCommand command = bikeApiMapper.toCommand(user.userId(), request);
    ...
    public ResponseEntity<ApiResponse> update(
        ...
        UpdateBikeCommand command = bikeApiMapper.toCommand(id, user.userId(), request);
    ...
    public ResponseEntity<ApiResponse> updateStatus(
        ...
        UpdateBikeStatusCommand command = bikeApiMapper.toCommand(id, user.userId(), request);
